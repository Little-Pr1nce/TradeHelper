...
class ForecastModelVersion:
    ...
    def __post_init__(self) -> None:
        ...
        if lifecycle is ModelLifecycle.CHAMPION and validation_status not in {
            ValidationStatus.CONFIRMATION_PASSED, ValidationStatus.NONINFERIOR_PASSED,
        }:
            raise ContractViolation("champion model version requires confirmed validation")
...
class ForecastResult:
    ...
    def __post_init__(self) -> None:
        ...
        if self.execution_eligible and not (
            lifecycle is ModelLifecycle.CHAMPION and validation in {
                ValidationStatus.CONFIRMATION_PASSED, ValidationStatus.NONINFERIOR_PASSED,
            }
        ):
