...
from contracts import DecisionDisposition, ExecutionLevel, EvidenceStatus, MarketEligibility, PlanAction, PlanReadiness
...
def rank_holdings(candidates, protective_decision_ids=()):
    ...
    def key(candidate):
        ...
        readiness_rank = {
            PlanReadiness.TRIGGERED: 0,
            PlanReadiness.WAITING: 1,
            PlanReadiness.OBSERVATION_ONLY: 2,
            PlanReadiness.NOT_APPLICABLE: 3,
        }[plan.readiness]
        ...
        return (readiness_rank, protective_rank, action_rank, _DISPOSITION[decision.disposition], _LEVEL[decision.level],
