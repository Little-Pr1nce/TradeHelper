...
from tradehelper_v2.contracts import (ConditionExpression, ConditionOperand, ConditionOperator, ContractViolation, EvidenceRequirement, HypothesisKind, HypothesisNovelty, OperandKind, ResearchHypothesis, stable_hash)
...
class StrictHypothesisParser:
    ...
    def _payload(self, kind, payload, facts, context):
        ...
        if kind is HypothesisKind.STRATEGY_CONFIGURATION:
            ...
            from tradehelper_v2.contracts import ScenarioState
