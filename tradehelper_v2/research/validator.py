...
from tradehelper_v2.contracts import CandidateEligibility, ConditionResult, FeatureStatus, HypothesisKind, HypothesisValidation, HypothesisValidationStatus, stable_hash
