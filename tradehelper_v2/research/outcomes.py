...
from tradehelper_v2.contracts import (HypothesisKind, HypothesisOutcome, HypothesisOutcomeStatus, HypothesisValidationStatus, LearningCandidateVersion, PromotionDecision, PromotionEvent, ResearchMetricSnapshot, stable_hash)
...
def metric_snapshot(*, market, scope_key, cutoff_at, hypotheses, validations, outcomes, generated_at, dimensions=()):
