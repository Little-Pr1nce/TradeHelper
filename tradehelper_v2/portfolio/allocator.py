...
from tradehelper_v2.risk.sizing import cash_required, planned_loss, round_lot_down
...
class PortfolioAllocator:
    ...
    def _profile(self, batch, snapshot, profile, generated_at):
        ...
        exit_release = _ZERO
        holding_candidates = [item for item in candidates if item.role.value == "holding"]
