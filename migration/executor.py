...
from contracts.enums import Exchange, Market
from contracts.market_data import InstrumentId, canonical_json, stable_hash, utc_iso
from contracts.migration import MigrationPlan, MigrationRun
from contracts.runtime import MigrationItemStatus, MigrationRunStatus
from contracts.presentation import WatchlistSnapshot
...
class MigrationExecutor:
    ...
    def _write_items(self, db, plan: MigrationPlan, run: MigrationRun):
        ...
        for market in Market:
            ...
            db.execute("INSERT OR IGNORE INTO watchlist_snapshots(watchlist_id,event_key,market,payload_hash,payload_json,created_at,schema_version) VALUES(?,?,?,?,?,?,?)",(snapshot.watchlist_id,snapshot.watchlist_id,market.value,digest,payload,utc_iso(plan.created_at),1))
