...
> 状态：设计已冻结，待实现。本文是 V2-11 的规范性合同，优先级高于 `V2_REFACTOR_PLAN.md` 中的概念示例。实现建立在已完成并复审的 V2-1 至 V2-10 冻结合同之上。V2-11 只负责应用读模型、结构化报告、历史评估展示、任务进度、Tab1/Tab3/历史报告/设置页面和 HTML/PDF 导出；不得提前完成 V1 正式数据迁移、完整生产端到端接线、安装包发布或券商自动下单，这些属于 V2-12。
